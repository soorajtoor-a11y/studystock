...
export default function DarkClosingCTA({ onStart, waitlistMode = false }) {
  return (
    <motion.section
      id={waitlistMode ? 'waitlist' : undefined}
    ...
    >
      <p className="mb-5 font-exam-mono text-[12px] tracking-[0.14em] text-exam-bone-faint">
        {waitlistMode ? 'EARLY ACCESS' : 'READY WHEN YOU ARE'}
      </p>
      ...
      <p className="mx-auto mt-6 max-w-[48ch] font-exam-grotesque text-[17px] leading-[1.6] text-exam-bone-soft">
        {waitlistMode
          ? "Vye is opening soon. Join the waitlist and we'll email you the moment your access is ready."
          : 'Completely free, every tool — no card, no trial. Pick an event and see your first practice test in under a minute.'}
      </p>
      {waitlistMode ? (
