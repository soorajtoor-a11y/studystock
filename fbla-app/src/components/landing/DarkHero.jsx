  ...
  return (
    <section className="relative overflow-hidden bg-exam-ink px-6 pb-20 pt-24 sm:px-10 sm:pb-28 sm:pt-32">
      ...
      <div className="relative mx-auto max-w-[1240px]">
        ...
        <h1 className="exam-display-axes mt-10 max-w-[16ch] font-exam-display text-[clamp(2.75rem,6.4vw,5.75rem)] font-medium leading-[1.03] tracking-[-0.01em] text-exam-bone sm:mt-14">
